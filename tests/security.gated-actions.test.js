...
const PWA_SHARED_ACTIONS = new Set(['declarer_panne', 'declarer_vol', 'delete_photo', 'modifier_resa', 'reserver', 'resoudre_panne', 'signaler_absence', 'statut_resa', 'supprimer_ligne_inventaire', 'transfert', 'upload_photo', 'valider']);
