...
test('GATED_ACTIONS_AUDIT et AUDIT_AUTH_ERRORS sont exportés et non vides', () => {
  ...
  assert.equal(W.GATED_ACTIONS_AUDIT.size, 81, 'périmètre attendu : les 81 actions gated (voir GATED_ACTIONS côté dashboard.html) — 62 + 9 actions Brasseurs d\'air (8 module + migrer_mouvement_brasseur, migration historique, ajoutée août 2026) + 9 actions Consultations EPI (fournisseurs, besoin figé, offres, ajoutées sept. 2026) + 1 action reporter_catalogue_epi (comparatif/attribution des offres, ajoutée sept. 2026)');
