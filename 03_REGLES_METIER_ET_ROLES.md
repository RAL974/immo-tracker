...
**Lot 2 (à venir)** : planning visuel par semaine/chantier (au-delà du Gantt actuel, groupé par immo), extension du digest hebdomadaire (`?digest=1`) avec une section "demandes en attente de traitement depuis plus de N jours".
